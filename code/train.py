...
# from old.model import BioGptForLongDocumentClassification
...
# from dainlp.modules.seq2seq.biogpt import BioGptForLongDocumentClassification
...
#     model = BioGptForLongDocumentClassification.from_pretrained(args.model_dir, config=config)
