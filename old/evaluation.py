...
def auc_metrics(yhat_raw, y, ymic):
    ...
    roc_auc["auc_micro"] = auc_metrics(fpr["micro"], tpr["micro"])
...
if __name__ == "__main__":
    if len(sys.argv) < 5:
        print("usage: python " + str(
            os.path.basename(__file__) + " [train_dataset] [|Y| (as string)] [version (mimic2 or mimic3)] [model_dir]"))
        sys.exit(0)
